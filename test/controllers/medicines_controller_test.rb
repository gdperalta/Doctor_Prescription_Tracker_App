...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { meds_cost: @medicine.meds_cost, meds_name: @medicine.meds_name } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { meds_cost: @medicine.meds_cost, meds_name: @medicine.meds_name } }
